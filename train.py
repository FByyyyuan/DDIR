...
def main():
    parser = argparse.ArgumentParser(description="Domain-Disentangled Invariant Representation Learning (5 source domains)")
    parser.add_argument("--name", type=str)
    parser.add_argument("--configs", nargs="*")
    parser.add_argument("--data_dir", type=str, default="***") #Please enter the dataset path
    parser.add_argument("--dataset", type=str, default="RotatedMNIST") #
    parser.add_argument("--algorithm", type=str, default="DDIR")
    ...
    parser.add_argument("--steps", type=int, default=5001, help="Number of steps. Default is dataset-dependent.")
    ...
    parser.add_argument("--weightpath", type=str, default="***") #Please enter the network parameters weight saving path
    ...
    keys = ["***"] # + args.configs #Please enter the config.yaml address
